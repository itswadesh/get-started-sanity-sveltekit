...
{#if count > 1}
	<div class="items-center justify-between border-t border-gray-200 lg:flex lg:pt-5">
		...
		<div class="flex items-center justify-center gap-2 text-center xl:mx-2">
			{#if +current > 1}
				<button
					class="inline-flex items-center rounded border border-gray-300 bg-white p-0.5 font-bold tracking-wide text-gray-800 hover:border-gray-800 focus:outline-none sm:p-2 lg:py-2 lg:px-4"
			...
			{#if +current < count}
				<button
					class="inline-flex items-center rounded border border-gray-300 bg-white p-0.5 text-center font-bold tracking-wide text-gray-800 hover:border-gray-800  focus:outline-none sm:p-2 lg:py-2 lg:px-4"
					on:click="{() => changePage(+current + 1)}">
