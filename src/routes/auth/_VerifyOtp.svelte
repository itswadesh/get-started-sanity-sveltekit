...
<div>
  <div
    class="mb-5 flex flex-col items-center justify-center space-y-1 text-center"
  >
    ...
    <div class="flex gap-2 text-xs">
      ...
      <button
        type="button"
        class="text-primary-500 hover:text-primary-700 font-bold focus:outline-none"
  ...
  >
    ...
    <button
      class="btn btn-primary mx-auto w-full max-w-sm"
      type="submit"
      {loading}
    >
      VERIFY
